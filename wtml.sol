...
/**
 *Submitted for verification at hecoinfo.com on 2021-04-24
*/
...
/**
   ...
   #WTML  
    ...
    I make this #WTML to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/WTMLTokenHECO
   ...
   I will renounce the ownership to burn addresses to transfer #WTML to the community, make sure it's 100% safe.

   I will add 1 HT and all the left 49% total supply to the pool
   Can you make #WTML 100X? 
   ...
   it's the best part of the #WTML idea, increasing the liquidity pool automatically, 
...
contract GNLSoken is Context, IERC20, Ownable {
    ...
    string private _name = "WATERMELON TOKEN";
    string private _symbol = "WTML";
